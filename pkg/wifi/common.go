...
func SetupWithDHCP(cfg SetupConfig) (*stacks.DHCPClient, *stacks.PortStack, *cyw43439.Device, string, error) {
	...
	if err != nil {
		return nil, stack, dev, connectedSsid, errors.New("dhcp begin request:" + err.Error())
	}
	i := 0
